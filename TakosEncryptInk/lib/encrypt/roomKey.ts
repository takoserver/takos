...
export async function encryptDataRoomKey(data: string, keyString: string): Promise<EncryptedDataRoomKeyObject> {
...
export async function decryptDataRoomKey(data: EncryptedDataRoomKeyObject, keyString: string): Promise<string> {
