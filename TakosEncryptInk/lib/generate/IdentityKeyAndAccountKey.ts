...
export function generateIdentityKeyAndAccountKeyObject(): {
  identityKey: {
    public: IdentityKeyPublicObject;
    private: IdentityKeyPrivateObject;
  };
  accountKey: {
    public: AccountKeyPublicObject;
    private: AccountKeyPrivateObject;
  };
} {
  ...
  return {
    identityKey: {
      public: identityPublicObject,
      private: identityPrivateObject,
    },
...
> {
  const MasterKeyPrivate: MasterKeyPrivateObject = JSON.parse(
    MasterKey.private,
  );
