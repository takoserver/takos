  ...
  if (state.page.value === 0) {
    return (
      <>
        ...
        <div class="p-4">
          <div class="flex items-center space-x-4">
            <div class="w-12 h-12 rounded-full flex items-center justify-center">
              <img src="/api/v2/client/users/icon" alt="Profile" class="rounded-full" />
            </div>
            <div>
        ...
        <div class="p-4">
          <div class="mb-4">
            <input type="text" placeholder="検索" class="w-full p-2 bg-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
            <h2 class="text-xl font-bold mb-2">友だちリスト</h2>
            <div class="space-y-2">
              <div class="flex items-center space-x-2">
                <img src="https://via.placeholder.com/50" alt="kuma" class="w-10 h-10 rounded-full" />
                <div>
              ...
              <div class="flex items-center space-x-2">
                <img src="https://via.placeholder.com/50" alt="がっきー" class="w-10 h-10 rounded-full" />
                <div>
              ...
              <div class="flex items-center space-x-2">
                <img src="https://via.placeholder.com/50" alt="富山 豊" class="w-10 h-10 rounded-full" />
                <div>
              ...
              <div class="flex items-center space-x-2">
                <img src="https://via.placeholder.com/50" alt="グループ" class="w-10 h-10 rounded-full" />
                <div>
