...
export function MainAuthForm({ sitekey, token }) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (
      values.userName === "" || values.password === "" || values.age === "" ||
      values.nickName === ""
    ) {
    ...
    <>
      {showForm || (
        <section class="text-gray-600 flex flex-col items-center px-2">
          <h1 class="text-3xl font-bold mt-10noyotei">
            takoserverアカウント登録
          </h1>
          <div class="w-2/3 m-auto">
            <form
              class="shadow-md rounded-md w-full max-w-2xl p-10"
            ...
            >
              <div class="flex sm:items-center mb-6noyotei flex-col sm:flex-row">
                <label
                  ...
                  for="name"
                >
                  ユーザーネーム <span class="text-red-600">*</span>
                </label>
                <input
              ...
              <div class="flex sm:items-center mb-6noyotei flex-col sm:flex-row">
                <label class="block sm:w-1/3 font-bold sm:text-right mb-1 pr-4">
                  パスワード
                </label>
                <input
              ...
              <div class="sm:items-center mb-6noyotei flex-col sm:flex-row">
                ...
                >
                  <a href="https://takos.jp/privacypolicy">
                    利用規約
                  </a>に同意します
                </label>
              </div>
