...
export function EncryptionSettingsModal(props: EncryptionSettingsModalProps) {
  // 内部の暗号化設定状態
  const [localIsEncrypted, setLocalIsEncrypted] = createSignal(props.isEncrypted);
  // 除外ユーザーリスト
  const [localExcludedUsers, setLocalExcludedUsers] = createSignal(props.excludedUsers || []);
  // 新規ユーザー入力用
    ...
    <Show when={props.isOpen}>
      <Portal>
        <div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div class="bg-[#333333] rounded-lg w-full max-w-md p-6 shadow-xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div class="mb-6">
                ...
                <div class="mt-4 text-sm text-gray-400">
                  ...
                  <div class="mt-4 border-t border-gray-700 pt-4">
                    ...
                    <div class="mt-3">
                      ...
                      <Show when={localExcludedUsers().length === 0}>
                        <p class="text-gray-500 italic">除外するユーザーがいません</p>
                      </Show>
                    </div>
                  </div>
                </div>
              ...
              <Show when={!localIsEncrypted()}>
                <div class="mt-4 text-sm text-orange-400">
                  ...
                  <p class="mt-2">サーバー管理者や中間者がメッセージの内容を閲覧できる可能性があります。</p>
                </div>
              </Show>
            </div>
