...
function createState() {
  ...
  const [isSelectServer, setIsSelectServer] = createSignal(
    settingJson.setDefaultServer,
  );
  const [ExproleServer, setExproleServer] = createSignal(
    settingJson.ExproleServer,
  );
