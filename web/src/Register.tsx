import ChatOtherMessage from "./OtherMessage";
import { createSignal } from "solid-js";
import settingJson from "./setting.json";

function createState() {
    const [serverDomain, setServerDomain] = createSignal(settingJson.domain);
    const [serverList, setServerList] = createSignal([]);
    const [isSelectServer, setIsSelectServer] = createSignal(settingJson.setDefaultServer);
    const [ExproleServer, setExproleServer] = createSignal(settingJson.ExproleServer);
