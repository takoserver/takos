...
((e, t) => {
  ...
  let F = () => {},
    r = function (t) {
      ...
      for (let a = 0; a < t.length; a++) {
        ...
        e < 128
          ...
          : (e < 2048
            ? r[n++] = e >> 6 | 192
            : (55296 == (64512 & e) && a + 1 < t.length &&
                56320 == (64512 & t.charCodeAt(a + 1))
              ? (e = 65536 + ((1023 & e) << 10) + (1023 & t.charCodeAt(++a)),
                r[n++] = e >> 18 | 240,
                r[n++] = e >> 12 & 63 | 128)
              : r[n++] = e >> 12 | 224,
              r[n++] = e >> 6 & 63 | 128),
    ...
    n = {
      ...
      encodeByteArray(r, e) {
        ...
        this.init_();
        var n = e ? this.byteToCharMapWebSafe_ : this.byteToCharMap_, a = [];
      ...
      decodeStringToByteArray(e, t) {
        this.init_();
        var r = t ? this.charToByteMapWebSafe_ : this.charToByteMap_, n = [];
  ...
  let H = () => x().__FIREBASE_DEFAULTS__,
    V = () => {
      var e;
      return "undefined" != typeof process && void 0 !== process.env &&
  ...
  function c(e, t) {
    if (e !== t) {
      var r, n, a = Object.keys(e), i = Object.keys(t);
      for (r of a) {
        if (!i.includes(r)) return;
        var s = e[r], o = t[r];
        if (X(s) && X(o)) { if (!c(s, o)) return; }
        else if (s !== o) return;
      }
  ...
  let te = {
    ...
    ae = (e, t, ...r) => {
      if (!(t < e.logLevel)) {
        var n = (new Date()).toISOString(), a = ne[t];
        if (!a) {
          throw new Error(
  ...
  let se = (t, e) => e.some((e) => t instanceof e), oe, le;
  let ce = new WeakMap(),
    g = new WeakMap(),
    he = new WeakMap(),
    b = new WeakMap(),
  ...
  function pe(e) {
    var i, t;
    return "function" == typeof e ? de(e) : (e instanceof IDBTransaction &&
      (i = e,
        g.has(i) || (t = new Promise((e, t) => {
          let r = () => {
  ...
  function ge(e, t) {
    if (e instanceof IDBDatabase && !(t in e) && "string" == typeof t) {
      ...
      let a = t.replace(/FromIndex$/, ""), i = t !== a, s = fe.includes(a);
      var r;
  ...
  class be {
    ...
    getPlatformInfoString() {
      return this.container.getProviders().map((e) => {
        var t;
        return "VERSION" === (null == (t = e.getComponent()) ? void 0 : t.type)
          ? (t = e.getImmediate()).library + "/" + t.version
          : null;
      }).filter((e) => e).join(" ");
    }
  }
  let C = "@firebase/app", w = "0.13.2", I = new ie("@firebase/app");
  var e;
  let D = "[DEFAULT]",
    ve = {
  ...
  class we extends Ee {
    constructor(e, t, r, n) {
      var a = void 0 === t.automaticDataCollectionEnabled ||
    ...
    incRefCount(e) {
      this.isDeleted ||
        (this._refCount++,
          void 0 !== e && null !== this._finalizationRegistry &&
  ...
  function T(e, t = {}) {
    ...
    var n = Object.assign({ name: D, automaticDataCollectionEnabled: !0 }, t);
    let a = n.name;
  ...
  function R(e, t, r) {
    let n, a = null != (n = ve[e]) ? n : e;
    r && (a += "-" + r);
    var i, s = a.match(/\s|\//), o = t.match(/\s|\//);
    s || o
  ...
  function De(e, t) {
    ...
    for (r of p) {
      ...
      n && n.level && (a = te[n.level]),
        r.userLogHandler = null === i ? null : (e, t, ...r) => {
          var n = r.map((e) => {
          ...
          t >= (null != a ? a : e.logLevel) &&
            i({ level: u[t].toLowerCase(), message: n, args: r, type: e.name });
        };
    }
  }
  function Se(e) {
  ...
  async function Be(e, t) {
    try {
      ...
      e instanceof s ? I.warn(e.message) : (r = B.create("idb-set", {
  ...
  class Re {
    constructor(e) {
      ...
      this._storage = new Pe(t),
        this._heartbeatsCachePromise = this._storage.read().then((e) =>
          this._heartbeatsCache = e
        );
    }
    async triggerHeartbeat() {
      ...
      try {
        var n,
          a = this.container.getProvider("platform-logger").getImmediate()
            .getPlatformInfoString();
        let t = ke();
        if (
          null !=
          ...
          (this._heartbeatsCache = await this._heartbeatsCachePromise,
            null !=
              (null == (r = this._heartbeatsCache) ? void 0 : r.heartbeats))
        ) {
          if (
            this._heartbeatsCache.lastSentHeartbeatDate !== t &&
            !this._heartbeatsCache.heartbeats.some((e) => e.date === t)
          ) {
            return this._heartbeatsCache.heartbeats.push({ date: t, agent: a }),
              30 < this._heartbeatsCache.heartbeats.length && (n = ((e) => {
  ...
  class Pe {
    ...
    async read() {
      ...
      return await this._canUseIndexedDBPromise &&
          null != (e = await (async (e) => {
              try {
                var t = (await Le()).transaction(k),
                  r = await t.objectStore(k).get(Te(e));
                return await t.done, r;
              } catch (e) {
                e instanceof s ? I.warn(e.message) : (t = B.create("idb-get", {
                  originalErrorMessage: null == e ? void 0 : e.message,
                }),
                  I.warn(t.message));
              }
    ...
    async overwrite(e) {
      ...
      if (await this._canUseIndexedDBPromise) {
        return r = await this.read(),
          Be(this.app, {
            lastSentHeartbeatDate: null != (t = e.lastSentHeartbeatDate)
              ? t
  ...
  class je {
    ...
    _getService(e, t = D) {
      ...
      var r, n = this._delegate.container.getProvider(e);
      ...
      s = {
        ...
        INTERNAL: {
          registerComponent: function (t) {
            let r = t.name, n = r.replace("-compat", "");
            {
              var e;
              L(t) && "PUBLIC" === t.type && (e = (e = o()) => {
                ...
                a.prototype[n] = function (...e) {
                  return this._getService.bind(this, r).apply(
                    this,
                    t.multipleInstances ? e : [],
                  );
                });
            }
  ...
  try {
    var $e, P = x();
    void 0 !== P.firebase && (Ve.warn(`
      Warning: Firebase is already defined in the global scope. Please make sure
      Firebase library is only loaded once.
    `),
      $e = P.firebase.SDK_VERSION) &&
      0 <= $e.indexOf("LITE") && Ve.warn(`
        Warning: You are trying to load Firebase while using Firebase Performance standalone script.
        You should load Firebase Performance with this instance of Firebase to avoid loading duplicate code.
        `);
  } catch (e) {}
  P = He;
  R("@firebase/app-compat", "0.4.2", void 0);
  return P.registerVersion("firebase", "11.10.0", "app-compat-cdn"), P;
});
