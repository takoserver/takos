          ...
          <div class="flex space-x-3">
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="flex items-center justify-between max-w-md">
                <button
                  type="button"
                  onClick={() => props.handleReply(post.id)}
                ...
                {/* リツイートボタン（コミュニティタブ以外で表示） */}
                {props.tab !== 'community' && (
                  <button
                    type="button"
                    onClick={() => props.handleRetweet(post.id)}
                ...
                <button
                  type="button"
                  onClick={() => props.handleLike(post.id)}
                  class={`flex items-center space-x-2 transition-colors group ${
                ...
                <button
                  type="button"
                  onClick={() => props.handleEdit(post.id, post.content)}
