                ...
                >
                  ...
                  >
                    <path
                      ...
                      stroke-linejoin="round"
                      stroke-width="2"
                      d="M7 4V2a1 1 0 011-1h4a1 1 0 011 1v2h4a1 1 0 011 1v2a1 1 0 01-1 1h-1v10a2 2 0 01-2 2H6a2 2 0 01-2-2V8H3a1 1 0 01-1-1V5a1 1 0 011-1h4z"
                    />
                  </svg>
                </button>
              </div>
                ...
                <div class="flex space-x-3">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center justify-between max-w-md">
                      ...
                      <button
                        type="button"
                        class="flex items-center space-x-2 text-gray-500 hover:text-green-400 transition-colors group"
                      >
