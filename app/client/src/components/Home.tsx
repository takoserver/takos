...
export function Home() {
  ...
  return (
    <div class="min-h-screen bg-[#121212] text-gray-100 flex">
      {/* エラーメッセージ表示 */}
      ...
      {/* サイドバー */}
      <aside class="w-64 bg-[#181818] p-6 flex-shrink-0">
        <h1 class="text-2xl font-bold text-teal-400 mb-8">Takos</h1>
        <nav>
          <ul>
            <li>
              <button
