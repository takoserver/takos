...
const developers = {
  tako: {
    ...
    body:
      "takoserverのリーダー!!マイクラサーバーや分散型チャットサービス「tako's」など様々なサービスを展開してます",
  },
  minai: {
    src: "/379213.jpg",
    name: "371tti",
    ...
    body:
      "しがないタコのコードのダメ出しをするうっさいやつ。姉妹？SNSをつくっている。なおjsが苦手",
  },
  nasuki: {
    src: "/natu.jpg",
    name: "natsuki",
    ...
    body:
      "ひまじんなつきひまじんなつきひまじんなつきひまじんなつきひまじんなつきひまじんなつき",
  },
  aranpect: {
    ...
    <>
      ...
      <div class="w-2/3 flex flex-col h-screen m-auto text-white">
        <main class="flex-1 overflow-y-auto py-6 pt-20">
          <h1 class="text-center pb-5 text-3xl lg:text-5xl">
            tako's developers
          </h1>
          ...
          <p>
            その他諸々<a
              class="text-blue-600 underline text-xl"
              href="https://github.com/orgs/takoserver/people"
            >
              github
            </a>
          </p>
