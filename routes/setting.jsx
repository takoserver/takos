...
function Setting() {
    return (<>
        ...
        <nav class="border-gray-800 border-r w-60 flex flex-col">
            ...
            <a class="flex items-center gap-2 py-2 px-3 rounded-md bg-gray-800 text-sm font-medium" href="#">
                <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <a class="flex items-center gap-2 py-2 px-3 rounded-md text-sm font-medium" href="#">
                <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <a class="flex items-center gap-2 py-2 px-3 rounded-md text-sm font-medium" onclick="alert('Yo!')" href="#">
                <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
...
function ProfileSetting() {
    return (<>
                ...
                <p class="text-sm text-gray-500">アカウントの情報を変更することができます</p>
                </div>
                <div class="grid gap-4">
                <div class="grid gap-1.5">
